...
export default class App {
    ...
    addImageBtn(el) {
        ...
        let object = this.game.createEntity(false);
    ...
    */
    ...
    doSave(event) {
        ...
        */
        ...
        $.post('http://dev.pgwm.vfs.local/~pg15teddy/Team/server/save/', request)
            .then(dataAsString => {
    ...
    doLoad(event) {
       ...
       $.post('http://dev.pgwm.vfs.local/~pg15teddy/Team/server/', 'pg15teddy')
       .then(dataAsString => {
           //console.log(dataAsString);
